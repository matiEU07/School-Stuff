...
function show_button(){
	document.getElementById("codeInput").innerHTML='<input type="text" id="hlaslo" placeholder="haslo" class="amongus"><button onclick="inputcode()">';
}
...
function inputcode()
{
	haslo = document.getElementById("hlaslo").value;
